...
First make sure that you downloaded the CSV file with the data. You can find it in the git repository in the data folder or in the data folder in the zip file under [Download CSV File](https://github.com/alpsteam/autonomous-labs/raw/master/lab-4/lab-4.zip)
